...
def main(args):
    ...
    transform_train = transforms.Compose([
        transforms.RandomResizedCrop(size=224, scale=(0.2, 1.)), # hardcoded TODO
        transforms.RandomHorizontalFlip(),
    ...
    dataset_train = datasets.ImageFolder(os.path.join(args.data_path, 'train'), transform=TwoCropTransform(transform_train))
    print(dataset_train)
